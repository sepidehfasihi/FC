    ...
    this.conf = {
      ...
      colors: {
        ...
        dashboard: {
          ...
          success: this.dashboardColors.success,
          successDark: this.dashboardColors.successDark,
          warning: this.dashboardColors.warning,
          pink: this.dashboardColors.pink,
          danger: this.dashboardColors.danger,
          white: this.dashboardColors.white,
        },
        dashboardArray:[
          this.dashboardColors.blueStone,
          this.dashboardColors.surfieGreen,
      this.dashboardColors.silverTree,
      this.dashboardColors.gossip,
      this.dashboardColors.successLight,
      this.dashboardColors.success,
      this.dashboardColors.successDark,
      this.dashboardColors.warning,
      this.dashboardColors.pink,
      this.dashboardColors.danger,
      this.dashboardColors.white
        ],
        custom: {
